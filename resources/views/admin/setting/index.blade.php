...
@push('script')
    ...
    <script>
        ...
        function setData(result) {
            ...
            $('input[name=config_value]').val(result.config_value);
            $('input[name=config_key]').val(result.config_key);
            $('.desc').val(result.description);
            $('.addit').val(result.additional);
            $('input[name=priority]').val(result.priority);
