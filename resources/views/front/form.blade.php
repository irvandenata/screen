...
<!-- Navbar & Hero Start -->
<div style="height: 700px" class="container-xxl py-5  mb-5">
                        ...
                        <div class="col-md-6">
                            @if($item->type=='select')
                                <div class="form-floating">
                                    ...
                                    <select class="form-control show-tick" name="{{ $item->name }}[]" id="typeID" required>
                            ...
                            @else
                                <div class=" form-floating">
                                    ...
                                    <input name="{{ $item->name }}[]" type="{{ $item->type }}" accept="image/*" class="form-control" id="name" placeholder="{{ $item->name }}" required>
